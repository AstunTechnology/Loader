...
ALTER TABLE "vml"."text" ADD COLUMN "featureid" VARCHAR;
...
ALTER TABLE "vml"."text" ADD COLUMN "orientation_uom" VARCHAR;
...
ALTER TABLE "vml"."vectormappoint" ADD COLUMN "featureid" VARCHAR;
...
ALTER TABLE "vml"."vectormappoint" ADD COLUMN "orientation_uom" VARCHAR;
...
ALTER TABLE "vml"."line" ADD COLUMN "featureid" VARCHAR;
...
ALTER TABLE "vml"."roadcline" ADD COLUMN "featureid" VARCHAR;
...
ALTER TABLE "vml"."area" ADD COLUMN "featureid" VARCHAR;
...
ALTER TABLE "vml"."railcline" ADD COLUMN "featureid" VARCHAR;
...
ALTER TABLE "vml"."railcline" ADD COLUMN "tile" VARCHAR;
